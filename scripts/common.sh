...
RVN_VISION_MODEL_DIR="$MODELS_DIR/Qwen3.8-27B-Heretic-Abliterated-W4A16-A100-Vision"
RVN_VISION_INPUTS_DIR="$MODELS_DIR/.rvn-vision-inputs"
RVN_VISION_METADATA_DIR="$RVN_VISION_INPUTS_DIR/metadata"
RVN_VISION_PAYLOAD_DIR="$RVN_VISION_INPUTS_DIR/vision"
RVN_VISION_SOURCE_LOCK="$RELEASE_ROOT/sources/rvn-vision.json"
